...
var aboga = function aboga() {
	...
	if (localStorage['lugar'] == 'abogados') {
		var casosAbogados = function casosAbogados(e) {
			_jquery2.default.get('casos-abogados.html', function (dato) {
				document.getElementById('contenido-abogado').innerHTML = dato;
			});
			e.preventDefault();
		};

		var solicitud = function solicitud(e) {
			_jquery2.default.get('solicitudes.html', function (dato) {
				document.getElementById('contenido-abogado').innerHTML = dato;
		...
		var informacionAbogado = function informacionAbogado(e) {
			_jquery2.default.get('informacion-abogados.html', function (dato) {
				document.getElementById('contenido-abogado').innerHTML = dato;
			});
			e.preventDefault();
		};

		var nuevoAbogado = function nuevoAbogado(e) {
			_jquery2.default.get('nuevo-abogado.html', function (dato) {
				document.getElementById('contenido-abogado').innerHTML = dato;
			});
			e.preventDefault();
		};
...
var cliente = function cliente() {
  if (localStorage['lugar'] == 'perfil') {
    var informacion = function informacion(e) {
      _jquery2.default.get('informacion-personal.html', function (data) {
    ...
    var casos = function casos(e) {
      _jquery2.default.get('casos.html', function (data) {
    ...
    var citas = function citas(e) {
      _jquery2.default.get('citas.html', function (data) {
...
var login = function login() {
  ...
  function logAb(e) {
    ...
    var usuario = (0, _jquery2.default)('#usuario-abogado').val();
    var pass = document.getElementById('passA').value;
  ...
  (0, _jquery2.default)("#login").submit(iniciar);
};
  ...
  if (localStorage['lugar'] == 'inicio') {
    var registrar = function registrar(e) {
      ...
      if (document.getElementById('pass1').value == document.getElementById('pass2').value) {
        ...
        _jquery2.default.ajax('/registrar', {
          type: 'post',
          dataType: 'json',
          data: datos,
          success: function success(data) {
...
var _login = require('./inicio/login');
...
var _registro = require('./registro/registro');
